...
display = Entry(font=('arial', 32 ,'bold'), fg="white", bg="cyan", textvariable=txt_input, justify="right")
...
btnc=Button(fg="black",bg="yellow", font=('arial',30,'bold'), text="c",command=clear,padx=35,pady=15).grid(row=1,column=3)
...
btnplus=Button(fg="black",bg="yellow", font=('arial',30,'bold'), text="+",command=lambda:btn("+"),padx=35,pady=15).grid(row=2,column=3)
...
btnminus=Button(fg="black",bg="yellow", font=('arial',30,'bold'), text="-",command=lambda:btn("-"),padx=40,pady=15).grid(row=3,column=3)
...
btndivision=Button(fg="black",bg="yellow", font=('arial',30,'bold'), text="/",command=lambda:btn("/"),padx=35,pady=15).grid(row=4,column=2)
btnmultiply=Button(fg="black",bg="yellow", font=('arial',30,'bold'), text="X",command=lambda:btn("*"),padx=35,pady=15).grid(row=4,column=3)

#row5
btnnequal=Button(fg="black",bg="blue", font=('arial', 30,'bold'), text="=",command=equal,padx=90,pady=15).grid(row=5,column=0,columnspan=2)
btnopen=Button(fg="black",bg="yellow", font=('arial',30,'bold'), text="(",command=lambda:btn("("),padx=35,pady=15).grid(row=5,column=2)
btnclose=Button(fg="black",bg="yellow", font=('arial',30,'bold'), text=")",command=lambda:btn(")"),padx=40,pady=15).grid(row=5,column=3)
